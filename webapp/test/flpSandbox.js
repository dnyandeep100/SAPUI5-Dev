		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo App for Git Hub branching",
									"targetURL": "#devdemodevdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"devdemodevdemo-display": {
								"semanticObject": "devdemodevdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=devdemo.devdemo",
									"url": sap.ui.require.toUrl("devdemo/devdemo")
								}
							}
						}
					}
